...
/**
 * Conversion band. These tools reach developers and technical users — exactly
 * the audience for Bhavesh's front-end engagements — so give them one clear,
 * low-pressure path to the portfolio.
 */
      ...
      <div className="flex flex-col items-start justify-between gap-6 p-6 sm:flex-row sm:items-center sm:p-8">
        <div>
          ...
          <p className="mt-2 max-w-xl text-muted-foreground">
            These tools are a small taste of the craft. If you need a fast, polished front-end for
            your enterprise SaaS, let&apos;s talk.
          </p>
        </div>
