...
export const metadata = {
    ...
    description: "Read the Privacy Policy of Everyday Tools regarding data collection, cookies, and user privacy.",
    keywords: [
        "Privacy Policy",
        "Data Collection Policy",
        "Google Ads Policy Compliance",
        "Everyday Tools Privacy",
    ...
    return (
      <div className="flex items-center justify-center min-h-screen p-6">
        <div className="max-w-3xl w-full">
          ...
          <p className="mb-4">
            Welcome to Everyday Tools. Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your information when you use our website.
          </p>
  
          <h2 className="text-2xl font-semibold mb-2">Information We Collect</h2>
          <p className="mb-4">
            Everyday Tools does not collect any personal data from users. However, third-party services such as Google Ads may collect information using cookies and similar technologies.
          </p>
